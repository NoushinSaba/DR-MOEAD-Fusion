# %% [markdown]
# # Hybrid Feature Fusion – Messidor Dataset
# ## Using Pre-trained DDR CNN Weights (No Re-training)
# 
# This notebook reuses the CNN trained on DDR for feature extraction on Messidor.
...
DATASET_ROOT = r'D:/DR Datasets/Messidor Dataset/'          # grade subfolders 0-4
CNN_WEIGHTS  = r'D:/Implementation/DR Code/cnn_feature_extractor.h5'
SAVE_DIR     = r'D:/Implementation/DR Code/Messidor Dataset/'
...
import os
dataset = "D:/DR Datasets/Messidor Dataset/"
