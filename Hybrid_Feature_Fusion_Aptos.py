# %% [markdown]
# # Hybrid Feature Fusion – DDR  Dataset
# ## Using Pre-trained DDR CNN Weights (No Re-training)
# 
# This notebook reuses the CNN trained on DDR for feature extraction on Aptos.
...
DATASET_ROOT = r'D:/DR Datasets/Aptos Dataset/'          # grade subfolders 0-4
CNN_WEIGHTS  = r'D:/Implementation/DR Code/cnn_feature_extractor.h5'
SAVE_DIR     = r'D:/Implementation/DR Code/Aptos Dataset/'
...
import os
dataset = "D:/DR Datasets/Aptos Dataset/"
